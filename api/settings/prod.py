...
DB_NAME = os.getenv('POSTGRES_NAME', 'default_db_name')
...
ALLOWED_HOSTS = ['localhost', '0.0.0.0', '127.0.0.1', 'emission-analyzer-api.onrender.com']
CSRF_TRUSTED_ORIGINS = [
    f'http://localhost:{port}', 'http://127.0.0.1:{port}',
    "https://emission-analyzer-api.onrender.com",
]
